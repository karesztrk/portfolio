...
function __wbg_adapter_22(arg0, arg1, arg2) {
    wasm.wasm_bindgen__convert__closures__invoke1_mut__h870b69ca9c946d72(arg0, arg1, addHeapObject(arg2));
}
...
* @returns {Maze}
*/
export function draw_maze(size) {
    const ret = wasm.draw_maze(size);
...
* @param {Maze} maze
*/
export function add_listeners(maze) {
    _assertClass(maze, Maze);
    wasm.add_listeners(maze.__wbg_ptr);
}
...
* @returns {Path}
*/
export function draw_path(maze, start, goal, algorithm) {
    _assertClass(maze, Maze);
    _assertClass(start, Point);
    var ptr0 = start.__destroy_into_raw();
    _assertClass(goal, Point);
    var ptr1 = goal.__destroy_into_raw();
    const ret = wasm.draw_path(maze.__wbg_ptr, ptr0, ptr1, algorithm);
...
* @param {Maze} maze
*/
export function clean(maze) {
    _assertClass(maze, Maze);
    wasm.clean(maze.__wbg_ptr);
}
...
/**
*/
export const Algorithm = Object.freeze({ Dijkstra:0,"0":"Dijkstra",Bfs:1,"1":"Bfs",Dfs:2,"2":"Dfs", });
/**
*/
export class Maze {
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('pathfinder_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
