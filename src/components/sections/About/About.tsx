      ...
      <Column>
        <Slide left>
          ...
          <p>
            ...
            myself as a Backend developer. And Java became my primary programming language. But as the trend changes, so
            I adapt. Building pixel perfect, dynamic and extreme fast applications because my obsession. HTML + CSS + JS
