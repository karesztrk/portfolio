    ...
    <Details>
      <Column>
        ...
        <p>
          ...
          Building pixel perfect, dynamic and extreme fast applications because
          my obsession. HTML + CSS + JS =&nbsp;<span>🤟</span>. I enjoy creating
          new stuff and embrace all the challenges they require.
        </p>
        <p>
