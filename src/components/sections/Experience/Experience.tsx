      ...
      <Tabs activeTab='minero'>
        <Tab tabKey='minero' title='Minero IT' buttonGrow={5}>
          <Content>
            ...
            <div>
              <p>
                I currently work at an outsourcing company called Minero. Here
                I've learn a lot. This is not just about about the enormous
                technical stuff but the way of delivering products to a customer
                in a mature way.
              </p>
              <ul>
                <li>
        ...
        <Tab tabKey='aensys' title='AENSys' buttonGrow={3}>
          <Content>
            ...
            <div>
              <p>
                Working at this company was my first step to build applications
                to end-users. It taught all things that can occur once the
